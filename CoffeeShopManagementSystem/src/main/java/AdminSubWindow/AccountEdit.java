...
public class AccountEdit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACCOUNT MODIFICATION");
        ...
        try {
            ...
            while(sqlResult.next()){
                if (rowLoopCount == row){
                    ...
                    accountType = sqlResult.getString("AccountType");
                }
    ...
    private void signUp(){
        ...
        try {
            ...
            String updateQuery = "UPDATE Accounts SET Username = ?, Password = ?, Name = ?, AccountType = ? WHERE Username = ? AND Password = ?";
            ...
            pstmt.setString(4, this.accountType);
