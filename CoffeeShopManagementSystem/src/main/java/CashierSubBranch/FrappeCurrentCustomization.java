 ...
 * @author User
 */
public class FrappeCurrentCustomization extends javax.swing.JFrame {

    /**
     * Creates new form FrappeCurrentCustomization
     */
    public FrappeCurrentCustomization() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FRAPPE CURRENT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrappeCurrentCustomization.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrappeCurrentCustomization().setVisible(true);
            }
        });
    }
